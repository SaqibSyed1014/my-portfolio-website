...
const Introduction = () => {
    ...
    return (
        <>
            ...
            <div id="profileImage" className="rounded-2xl md:rounded-[30px] lg:rounded-[48px] overflow-hidden mt-36 md:mt-28 lg:absolute lg:top-[36vh] lg:right-0 col-span-12 lg:col-start-6 w-full lg:w-[50vw] lg:col-span-6 z-0">
